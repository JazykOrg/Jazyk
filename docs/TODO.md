...
- [x] `bootstrap` proof of concept against the example projects (see
...
- [x] Measure the declarative-obligation doctrine: re-dogfood density vs the strict run
  (see `bootstrap/VALIDATION.md`, the density experiment).
- [x] Stronger-model comparison through LocalRouter (`gpt-5.5`: density, end to end,
  self-hosting, stability; see `bootstrap/VALIDATION.md`).
- [x] Converge the docs dogfood: 185/185 sections covered, 0 errors, 0 parked. The
...
- [ ] Full docs gen and verify run to verdicts with a capable model
