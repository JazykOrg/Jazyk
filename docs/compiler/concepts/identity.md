...
views from their rule (`view:class/<scope>`, `view:component/<system-slug>`,
`view:usecase/<cluster-slug>`, `view:sequence/<cluster-slug>`,
`view:state/<entity-slug>`, `view:object/<type-slug>`), per
